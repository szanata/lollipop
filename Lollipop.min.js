...
b.find("#lollipop-popup-header").hide()}function v(){var a=$("<div></div>").css({clear:"both",width:0,height:0});b.find("#lollipop-popup-body").append(a)}function n(){b.find("#lollipop-popup").css("padding-bottom",b.find("#lollipop-popup-footer:visible").size()?b.find("#lollipop-popup-footer").outerHeight(!0):0);l();k();p();q()}var e={},d={minWidth:400,maxWidth:500,width:null,minHeight:200,maxHeight:400,height:null,animate:!0,animateOnClose:!0,title:null,showHeader:!0,showFooter:!0,showCancelButton:!0,
cancelButtonTitle:"Cancel",onCancel:null,content:null,onBeforeOpen:null,onOpen:null,onClose:null,buttons:[]},g=h(d),b=$("<div></div>").css({position:"absolute",top:"0px",left:"0px",right:"0px",zIndex:9999}).append($('<div id="lollipop-block-layer"></div>').css({position:"absolute",top:"0px",bottom:"0px",left:"0px",right:"0px"}),$('<div id="lollipop-popup"></div>').css({maxWidth:d.maxWidth,maxHeight:d.maxHeight,minWidth:d.minWidth,minHeight:d.minHeight,position:"absolute"}).append($('<div id="lollipop-popup-header"></div>').css({textOverflow:"ellipsis",
overflow:"hidden"}),$('<div id="lollipop-popup-body"></div>'),$('<div id="lollipop-popup-footer"></div>').css({position:"absolute",bottom:"0px",left:"0px",right:"0px"})));Object.freeze&&Object.freeze(d);e.seeDefaults=function(){return h(d)};e.config=function(a){$.extend(g,d,a)};e.open=function(a){var c={};$.extend(c,g,a);u(c);b.find("#lollipop-popup-body").html("");b.find("#lollipop-popup-body").append(c.content);b.data("__closeCallback",c.onClose);t(c);v();s(c);b.hide().appendTo($("body"));f(c.onBeforeOpen)&&
c.onBeforeOpen.call(b[0]);c.animate?b.css("visibility","hidden").show(0,function(){n();b.hide().css("visibility","visible").fadeIn(function(){f(c.onOpen)&&c.onOpen.call(this)})}):b.show(0,function(){n();f(c.onOpen)&&c.onOpen.call(this)})};e.close=function(a){a||!g.animateOnClose?(b.find("#lollipop-popup-body").html(""),b.detach()):b.fadeOut(function(){b.find("#lollipop-popup-body").html("");b.detach()});a=b.data("__closeCallback");f(a)&&a.call(b[0]);$(window).off("keydown.lollipop");$(window).off("resize.lollipop");
$(window).add("html, body").off("scroll.lollipop")};Object.freeze&&Object.freeze(e);"function"===typeof define&&define.amd?define(function(){return e}):window.Lollipop=e})();
