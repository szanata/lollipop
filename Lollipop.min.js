...
typeof a.onCancel)a.onCancel();Lollipop.close()}}))}b.hide().appendTo($("body"));a.animate?b.css("visibility","hidden").show(function(){i();b.hide().css("visibility","visible").fadeIn(function(){"function"===typeof c.onOpen&&c.onOpen.call(this)})}):b.show(function(){i();"function"===typeof c.onOpen&&c.onOpen.call(this)})};Lollipop.close=function(c){c?b.remove():b.fadeOut(function(){b.remove()});$(window).off("keydown.lollipop");$(window).off("resize.lollipop");$(window).add("html, body").off("scroll.lollipop")};
